...
class Login:
    ...
    personal_account = (By.XPATH, ".//a[@href='/account']")  #Личный кабинет на главной странице
    login_from_form = (By.XPATH, ".//a[@href='/login' and text()='Войти']")  #Ссылка Войти под формой регистрации
    login_forgot_password = (By.XPATH, ".//a[@href='/login' and text()='Войти']")  #Ссылка Войти на странице восстановления пароля
...
class Account:
    constructor = (By.XPATH, ".//a[@href='/' and @class='AppHeader_header__link__3D_hX']") #Кнопка Конструктор на главной страницу
    logo = (By.XPATH, ".//div[contains(@class, 'AppHeader_header__logo')]//a[@href='/']") #Логотип на главной странице
